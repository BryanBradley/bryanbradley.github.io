...
// window.addEventListener("scroll", checkAboutImageVisible);
// let aboutImageVisible = false;

// function checkAboutImageVisible() {
...
//     const percentVisible = (windowHeight - rect.top) / (windowHeight + rect.height);
//     aboutImageVisible = percentVisible >= 0 && percentVisible < 0.8;
...
//         social.classList.add("fade-in-left");
//       } else {
//         social.classList.remove("fade-in-left");
//       }
//     } else {
//       social.classList.remove("fade-in-left");
//     }
...
//   if (rect.top + rect.height / 2 <= windowHeight && rect.bottom >= rect.height / 2) {
//     skillCard.classList.add("visible");
//   } else {
//     skillCard.classList.remove("visible");
//   }
// });
// }
